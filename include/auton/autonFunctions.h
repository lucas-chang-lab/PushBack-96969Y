...
namespace autonFunctions {
    ...
    void driveRotatateDistanceTiles(double distanceTiles, double rotation, double maxVelocityPct = 100, double rotateCenterOffsetIn = 0, double errorRange = defaultMoveTilesErrorRange, double runTimeout = 3.0);
