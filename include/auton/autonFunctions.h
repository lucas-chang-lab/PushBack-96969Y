...
namespace autonFunctions {
    ...
    void goToPointTiles(double targetX, double targetY, double maxPct = 100.0, double errorRange = defaultMoveTilesErrorRange, double runTimeout = 5.0, bool approachFront = true);
    ...
    void setMatchLoader(int state, double delaySec = 0);
}